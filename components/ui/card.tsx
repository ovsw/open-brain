...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "rounded-[1.75rem] border border-border/60 bg-card/85 text-card-foreground shadow-[0_24px_70px_rgba(86,52,31,0.12)] backdrop-blur-xl",
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card-title" className={cn("font-serif text-3xl font-semibold tracking-tight", className)} {...props} />;
}
